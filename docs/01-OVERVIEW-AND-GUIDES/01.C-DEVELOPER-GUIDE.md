...
The `JobRequest` object, defined in `src/models/request.ts`, serves as the canonical data structure that carries the full, validated context of an incoming request to the asynchronous worker.
