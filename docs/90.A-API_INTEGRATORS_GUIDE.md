...
Mapping:
- ICA: the deployment-specific ICA endpoint
...
[
  ...
  { "issuer": "https://securetoken.google.com/example-project", "audience": "example-project" }
]
```
...
- The direct `Composition/_batch` flow below is a legacy or lower-level route
  kept here as transitional material.
