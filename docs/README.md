...
- **Authenticated clinical provenance**: [101-01.N-AUTHENTICATED-CLINICAL-AUTHOR.md](01-OVERVIEW-AND-GUIDES/101-01.N-AUTHENTICATED-CLINICAL-AUTHOR.md) explains the application-facing organization, professional-assignment and employee audit relationship without requiring ledger knowledge; its [public-SDK snippet](01-OVERVIEW-AND-GUIDES/snippets/authenticated-clinical-data.ts) is the copyable BFF path, while [the internal ledger schema](../docs-v2/28-clinical-employee-ledger-schema.md) owns hashing and record-layout details.
