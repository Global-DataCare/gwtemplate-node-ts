...
*   **[03.K-LEGACY-REPRESENTATIVE-CONTROLLER-COMPATIBILITY.md](03-IDENTITY-AND-TRUST/03.K-LEGACY-REPRESENTATIVE-CONTROLLER-COMPATIBILITY.md)**: Fail-closed restoration of one scoped historical legal-representative bootstrap controller without checked-in personal identifiers.
