...
DEFAULT_HOST_REGISTRY_SECTOR="test"
if [[ "$NETWORK_MODE_NORMALIZED" == "local-network" || "$NETWORK_MODE_NORMALIZED" == "test-network" || "$NETWORK_MODE_NORMALIZED" == "network" ]]; then
  DEFAULT_HOST_REGISTRY_SECTOR="$NETWORK_MODE_NORMALIZED"
fi
HOST_REGISTRY_SECTOR="${HOST_REGISTRY_SECTOR:-$DEFAULT_HOST_REGISTRY_SECTOR}"
