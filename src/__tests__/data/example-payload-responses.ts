...
// File: src/__tests__/data/example-payload-responses.ts

/**
 * This file is generated/updated from a real in-memory run of the onboarding journey.
 *
 * Generate (local/dev):
 *   `node --loader ts-node/esm --experimental-specifier-resolution=node scripts/run-api-integrators-guide-flow.mts`
 *
