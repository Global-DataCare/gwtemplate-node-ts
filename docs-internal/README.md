...
These documents track implementation planning and handoff context. They are
not API contracts or production-readiness evidence.

- [BACKLOG.md](BACKLOG.md): current GW CORE work items
