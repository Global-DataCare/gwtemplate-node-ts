...
For general testing strategy and tiers, see [06.D-TESTING-GUIDE.md](06.D-TESTING-GUIDE.md).
...
Ensure you have a Google Cloud Project dedicated to testing. The examples use
the placeholder project ID `<YOUR_PROJECT_ID>`.
...
1.  **Add Firebase to your GCP Project:**
    ...
    -   Click **"+ Add project"** and **select your existing GCP project**. Do NOT create a new one.
...
3.  **Configure Cloud Storage:**
    ...
    -   Click **"+ Grant Access"**.
    -   In **New principals**, paste the full email of the service account you created (for example, `vault-e2e-tester@<YOUR_PROJECT_ID>.iam.gserviceaccount.com`).
...
2.  Use `env.example` as a template and fill in all the required values you gathered from the steps above. It should look similar to this:
    ...
    GCS_BUCKET_NAME=<YOUR_PROJECT_ID>.appspot.com
