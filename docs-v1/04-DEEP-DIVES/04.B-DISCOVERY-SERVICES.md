...
persisted during `_activate` and later projected into DID and DSP discovery.
...
For complete details on how a tenant's capabilities are defined during onboarding, see the [organization registration guide](04.A-ORGANIZATION-REGISTRATION.md).
