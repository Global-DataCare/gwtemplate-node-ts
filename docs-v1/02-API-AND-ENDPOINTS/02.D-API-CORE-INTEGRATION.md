...
This document mirrors the live SDK CORE E2E flow and records only the
demonstrated integration boundary.

Short coverage summary for memory/thesis justification:
- [`06.G-CORE-TEST-EVIDENCE.md`](../06-AUDIT-AND-EVIDENCE/06.G-CORE-TEST-EVIDENCE.md)
...
the external portal/BFF. GW CORE does not publish those products
...
- Visual public/internal contract map:
  [01.H-GW-CORE-CONTRACT-MAP.md](../01-OVERVIEW-AND-GUIDES/01.H-GW-CORE-CONTRACT-MAP.md).
