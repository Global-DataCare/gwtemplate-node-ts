...
deploy_cloud_run() {
  ...
  local runtime_vars=(
    ...
    "AUTH_TOKEN_VERIFIER" "OIDC_TRUSTED_PROVIDERS_JSON" "TENANT_SERVICE_ROUTES_JSON"
    ...
    "ENVELOPE_PROVIDER" "KEK_SECRET" "KMS_KEY_ID" "KMS_RUNTIME_KEK_CIPHERTEXT" "KMS_RUNTIME_KEK_ID" "AWS_REGION" "AWS_DEFAULT_REGION"
    "GCP_KMS_KEY_NAME" "GCP_KMS_RUNTIME_KEK_CIPHERTEXT" "GCP_KMS_RUNTIME_KEK_ID"
