...
[01-narrative-rules.md](./01-narrative-rules.md), plus repository
...
> - Read [26-tutorial-reading-order.md](./26-tutorial-reading-order.md) for the ordered current path.
...
- [API_CORE_INTEGRATION.md](../docs-v1/02-API-AND-ENDPOINTS/02.D-API-CORE-INTEGRATION.md)
...
- [11-host-organization-activation.md](./11-host-organization-activation.md)

### Individual index bootstrap

Use the tenant-level individual bootstrap flow to create the indexed individual context.

- [12-individual-index-bootstrap.md](./12-individual-index-bootstrap.md)
...
- [13-communication-batch-index-data.md](./13-communication-batch-index-data.md)
...
- [22-digital-twin-search.md](./22-digital-twin-search.md)
...
- [14-subject-summary.md](./14-subject-summary.md)

### SMART token

- [15-smart-token.md](./15-smart-token.md)

### Related person

- [16-related-person-index-data.md](./16-related-person-index-data.md)
...
Superseded approaches remain only in Git history:
