...
> - Treat `docs-v1/01-*` 101 notes as detailed reference, not the primary current entrypoint.
...
- begin with the application-facing explanation of legal-organization authors,
  ...
  [Authenticated clinical authorship](../docs-v1/01-OVERVIEW-AND-GUIDES/01.M-AUTHENTICATED-CLINICAL-AUTHOR.md)
- copy the public SDK flow from
  [authenticated-clinical-data.ts](../docs-v1/01-OVERVIEW-AND-GUIDES/snippets/authenticated-clinical-data.ts)
- consult [the internal ledger schema](./25-clinical-employee-ledger-schema.md)
...
4. [10-api-integrator-guide.md](./10-api-integrator-guide.md)
5. [19-organization-controller-lifecycle.md](./19-organization-controller-lifecycle.md)
